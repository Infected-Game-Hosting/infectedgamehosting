                      ...
                      <div className="w-44 lg:w-48 p-2 lg:p-3 space-y-1 bg-[#0b0b0f] border border-white/10 rounded-md">
                        {gamesItems.map((item) => (
                          <NavigationMenuLink asChild key={item.title}>
                            <a
                              href={item.href}
                              className="games-dropdown-item flex items-center gap-2 px-3 lg:px-4 py-2 text-xs lg:text-sm text-[#c8cbd0] rounded-md  hover:text-[#39ff14] transition-colors"
                            >
                              {item.title}
                            </a>
                          </NavigationMenuLink>
                      ...
                      <div className="w-72 lg:w-80 p-3 lg:p-4 space-y-2 bg-[#0b0b0f] border border-white/10 rounded-md">
                        {otherItems.map((item) => (
                          <NavigationMenuLink asChild key={item.title}>
                            <a
                              href={item.href}
                              className="other-dropdown-item flex items-start gap-3  transition-all"
                            >
